...
(NULL, 'Hom Ken Food', 'Hom Ken', 'L1029234599', '06-23458477', NULL, NULL, SYSDATE(6), SYSDATE(6));
...
CREATE TABLE ProductPerLeverancier (
  ...
  ,ProductId INT UNSIGNED NOT NULL
  ,MagazijnId INT UNSIGNED NULL DEFAULT NULL
...
(7, 14, NULL, '2023-04-14', 20, NULL, 1, NULL, SYSDATE(6), SYSDATE(6));